...
class Product extends CommonObject
{
	 ...
	 * 	@return     int     				<0 if KO, >0 if OK
	 */
	function correct_stock($user, $id_entrepot, $nbpiece, $movement, $label='', $price=0, $inventorycode='', $pushToConnec=true)
	{
		if ($id_entrepot)
		{
			$this->db->begin();
	 ...
	 * 	@return     int     				<0 if KO, >0 if OK
	 */
	function correct_stock_batch($user, $id_entrepot, $nbpiece, $movement, $label='', $price=0, $dlc='', $dluo='',$lot='', $inventorycode='', $pushToConnec=true)
	{
		if ($id_entrepot)
		{
			$this->db->begin();
