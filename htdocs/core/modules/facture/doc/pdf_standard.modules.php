...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_standard.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from standard model
 */
...
/**
 *	Class to manage PDF invoice template standard
 */
class pdf_standard extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "standard";
		$this->description = "Standard template for Invoicing";
